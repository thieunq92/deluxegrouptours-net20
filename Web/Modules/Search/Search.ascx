<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Search.ascx.cs" Inherits="CMS.Modules.Search.Search" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
