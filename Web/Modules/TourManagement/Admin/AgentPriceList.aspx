<%@ Page Language="C#" MasterPageFile="TourMaster.Master" AutoEventWireup="true"
    Codebehind="AgentPriceList.aspx.cs" Inherits="CMS.Modules.TourManagement.Web.Admin.AgentPriceList"
    Title="Untitled Page" %>
    ...
    <asp:Panel ID="panelContent" runat="server">
        <fieldset>
            ...
            <div class="settinglist">
                ...
                <asp:Button runat="server" ID="btnAddPrice" Text="Thêm mức giá" OnClick="btnAddPrice_Click"
                    CssClass="button" />
            </div>
        </fieldset>
    </asp:Panel>
