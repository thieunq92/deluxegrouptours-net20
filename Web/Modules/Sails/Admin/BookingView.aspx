                ...
                <div class="search_panel">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDriverCollect" runat="server" data-inputmask="'alias': 'decimal', 'groupSeparator': ',', 'autoGroup': true" Width="87"></asp:TextBox>
                                <asp:DropDownList ID="ddlCurrencyDriverCollect" runat="server" Width="60">
                                    <asp:ListItem Value="true">VND</asp:ListItem>
                                    <asp:ListItem Value="false">USD</asp:ListItem>
                                </asp:DropDownList>
                            </td>
