        ...
        <div class="search_panel">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlAgencies" runat="server" Visible="false">
                        </asp:DropDownList>
                        <asp:TextBox ID="txtAgency" runat="server" Visible="true"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <FooterTemplate>
                            <tr class="item">
                                ...
                                <td style="text-align: right;">
                                 ...
                                 <td style="text-align: right;">
                                    <strong>
                                        <asp:Label ID="label_GuideCollect" runat="server"></asp:Label></strong>
                                </td>
                                 <td style="text-align: right;">
                                    <strong>
                                        <asp:Label ID="label_GuideCollectVND" runat="server"></asp:Label></strong>
                                </td>
                                <td style="text-align: right;">
                                    <strong>
