<%@ Page Language="C#" MasterPageFile="SailsMaster.Master" AutoEventWireup="true" CodeBehind="GuideCollects.aspx.cs" Inherits="Portal.Modules.OrientalSails.Web.Admin.GuideCollects" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        Guide</td>
                    <td>
                        <asp:TextBox ID="txtGuide" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        Booking Code</td>
        ...
        <div style="float:right;">
            ...
            <ul style="list-style: none; padding: 0px; padding-top: 5px; margin: 0px; margin-top: 10px;"
                    class="tabbutton">
                <li id="liAllPaid" runat="server"><asp:HyperLink ID="hplAllPaid" runat="server">All</asp:HyperLink></li>
                <li id="liNotPaid" runat="server"><asp:HyperLink ID="hplNotPaid" runat="server">Not paid</asp:HyperLink></li>
                <li id="liPaid" runat="server"><asp:HyperLink ID="hplPaid" runat="server">Paid</asp:HyperLink></li>
            </ul>
        </div>
