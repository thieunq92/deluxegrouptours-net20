    ...
    <fieldset>
        ...
        <div class="settinglist">
            <table>
                <tr>
                    <td>
                        <asp:CheckBox ID="chkSendMail" runat="server" Checked="false" CssClass="checkbox" Visible="False"/></td>
                    <td>
                        <asp:Button ID="buttonSubmit" runat="server" CssClass="button" OnClick="buttonSubmit_Click" /></td>
                    <td>
                        <asp:Button ID="buttonCancel" runat="server" CssClass="button" OnClick="buttonCancel_Click" /></td>
                    <td>
...
<%--                            <asp:DropDownList ID="ddlTrips" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtGuideCollect" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <%= base.GetText("textPaymentNeeded") %>
                        </td>
                        <td>
                            <asp:CheckBox ID="chkIsPaymentNeeded" runat="server" CssClass="checkbox" /></td>
                    </tr>                    
                    <tr>
                        <td>Commission</td>
                        <td><asp:TextBox ID="txtCommission" runat="server"></asp:TextBox></td>
                        <!--<td>Invoice</td>
                        <td><asp:CheckBox ID="chkInvoice" runat="server" /></td>                        -->
                        <td>Cancel penalty</td>
                        <td><asp:TextBox ID="txtPenalty" runat="server" Text="0"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <asp:PlaceHolder ID="plhAccountStatus" runat="server">
                            ...
                            <td>
                                <asp:Button ID="btnAccountingUpdate" runat="server" CssClass="button" OnClick="btnAccountingUpdate_Click" /></td>
                        </asp:PlaceHolder>
                    </tr>
                                            ...
                                            <asp:Repeater ID="rptServices" runat="server" OnItemDataBound="rptServices_ItemDataBound" OnItemCommand="rptServices_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><asp:Button ID="btnRemove" runat="server" Text="Remove" CommandName="remove" CssClass="button"/></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </table>
                    ...
                    <asp:PlaceHolder ID="plhCharter" runat="server">
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkCharter" runat="server" /></td>
                            <td>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkIsTransferred" runat="server" /></td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtTransferCost" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr id="trTransferCustomer" runat="server">
                            ...
                            <td>
                                <asp:TextBox ID="txtTransferAdult" runat="server"></asp:TextBox></td>
                            <td>
                                <%= base.GetText("textTransferChildren") %>
                            </td>
                            <td>
                                <asp:TextBox ID="txtTransferChildren" runat="server"></asp:TextBox></td>
                            <td>
                                <%= base.GetText("textTransferBaby") %>
                            </td>
                            <td>
                                <asp:TextBox ID="txtTransferBaby" runat="server"></asp:TextBox></td>
                        </tr>
                    </asp:PlaceHolder>
                    <tr>
                        <td colspan="6">
            ...
            <div class="basicinfo">
                <table cellspacing="3">
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="txtPickup" runat="server" TextMode="MultiLine" Width="100%"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="txtSpecialRequest" runat="server" TextMode="MultiLine" Width="100%"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="txtCustomerInfo" runat="server" TextMode="MultiLine" Width="100%"></asp:TextBox></td>
                    </tr>
                </table>
            </div>
        </div>
        <asp:Button ID="btnInvoice" runat="server" Text="Invoice" CssClass="button"
                ...
                <asp:Repeater ID="rptCustomers" runat="server" OnItemDataBound="rptCustomers_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                           ...
                           <td><asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" CssClass="button" Text="Delete"/></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </table>
