<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditProfile.ascx.cs" Inherits="CMS.Modules.User.EditProfile" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
