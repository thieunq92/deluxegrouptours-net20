...
ALTER TABLE cm_forumcategory WITH CHECK ADD  CONSTRAINT [FK_cm_forumcategory_bitportal_site] FOREIGN KEY([siteid])
REFERENCES bitportal_site ([siteid])
GO
ALTER TABLE cm_forumcategory CHECK CONSTRAINT [FK_cm_forumcategory_bitportal_site]
GO
...
GO
ALTER TABLE cm_forums CHECK CONSTRAINT [FK_cm_forums_cm_forumcategory]
GO
ALTER TABLE cm_forumposts  WITH NOCHECK ADD  CONSTRAINT [FK_cm_forumposts_cm_forumfile] FOREIGN KEY([attachmentid])
REFERENCES cm_forumfile ([id])
NOT FOR REPLICATION 
GO
ALTER TABLE cm_forumposts NOCHECK CONSTRAINT [FK_cm_forumposts_cm_forumfile]
GO
ALTER TABLE cm_forumposts  WITH NOCHECK ADD  CONSTRAINT [FK_cm_forumposts_cm_forumposts] FOREIGN KEY([replytoid])
REFERENCES cm_forumposts ([postid])
NOT FOR REPLICATION 
GO
ALTER TABLE cm_forumposts NOCHECK CONSTRAINT [FK_cm_forumposts_cm_forumposts]
GO
...
GO
ALTER TABLE cm_forumposts CHECK CONSTRAINT [FK_cm_forumposts_cm_forums]
GO
ALTER TABLE cm_forumposts  WITH CHECK ADD  CONSTRAINT [FK_cm_forumposts_bitportal_user] FOREIGN KEY([userid])
REFERENCES bitportal_user ([userid])
GO
ALTER TABLE cm_forumposts CHECK CONSTRAINT [FK_cm_forumposts_bitportal_user]ALTER TABLE [cm_forumposts] CHECK CONSTRAINT [FK_cm_forumposts_bitportal_user]
GO
ALTER TABLE cm_forumuser  WITH CHECK ADD  CONSTRAINT [FK_cm_forumuser_bitportal_user] FOREIGN KEY([userid])
REFERENCES bitportal_user ([userid])
GO
ALTER TABLE cm_forumuser CHECK CONSTRAINT [FK_cm_forumuser_bitportal_user]
GO
...
INSERT INTO bitportal_moduletype (name, assemblyname, classname, path, editpath, inserttimestamp, updatetimestamp) VALUES ('Forum', 'Portal.Modules.Forum', 'Portal.Modules.Forum.ForumModule', 'Modules/Forum/UserForum.ascx', 'Modules/Forum/AdminForum.aspx', '2005-02-11 14:36:28.324', '2004-02-11 14:36:28.324')

SELECT @moduletypeid = Scope_Identity()

INSERT INTO bitportal_version (assembly, major, minor, patch) VALUES ('Portal.Modules.Forum', 1, 5, 1)
go
