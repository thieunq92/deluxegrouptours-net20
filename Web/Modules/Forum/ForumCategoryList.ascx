<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ForumCategoryList.ascx.cs" Inherits="Portal.Modules.Forum.Web.ForumCategoryList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
