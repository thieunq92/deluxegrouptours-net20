...
<%@ Register TagPrefix="uc2" TagName="navigationpath" Src="~/Controls/Navigation/NavigationPath.ascx" %>
...
<div id="container">
    ...
    <div class="right-border">
	    ...
	    <div style="float:left; width :649px; margin-left:20px;">
	...
	<img id="Img2" src="/Images/vtvlg.png" alt="VTV3 - LG" runat="server"/>
</div>
		</form>
	</body>
</html>
