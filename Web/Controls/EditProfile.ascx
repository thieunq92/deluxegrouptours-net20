<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditProfile.ascx.cs" Inherits="CMS.Web.Controls.EditProfile" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<asp:panel id="pnlEdit" runat="server">
	...
	<table class="tbl">
		...
		<tr>
			<td>Phone</td>
			<td>
				<asp:textbox id="txtWebsite" runat="server" maxlength="100" width="200px"></asp:textbox></td></tr>
		<tr>
