            ...
            <div class="data_grid">
                <table>
                    <asp:Repeater ID="rptBookingList" runat="server" OnItemDataBound="rptBookingList_ItemDataBound"
                        ...
                        <HeaderTemplate>
                            <tr class="header">
                                ...
                                <th rowspan="2" id="thTrip" runat="server">
                                    <%# base.GetText("textTrip") %>
                                </th>
                                <th rowspan="2" id="thTime" runat="server">
                                    Time
                                </th>
                                <th rowspan="2">
                                    <%# base.GetText("textPickupAddress") %>
                                </th>
                                <th rowspan="2" id="thDropoffAddress" runat="server">
                                    Dropoff Address
                                </th>
                                <th rowspan="2" id="thFlightDetails" runat="server">
                                    Flight Details
                                </th>
                                <th rowspan="2" id="thCarRequirements" runat="server">
                                    Car Type
                                </th>
                                <th rowspan="2" id="thSpecialRequest" runat="server">
                        ...
                        <ItemTemplate>
                            <tr class="item" id="trItem" runat="server">
                                ...
                                <td id="tdSpecialRequest" runat="server">
                    ...
                    <asp:Repeater runat="server" ID="rptShadows" OnItemDataBound="rptBookingList_ItemDataBound">
                        <HeaderTemplate>
                            <tr>
                                <td colspan="12" style="background-color: #FF7F7F;">
                                    Booking moved (to another date) or cancelled need attention (within 2 days)
                                </td>
                            </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
                ...
                <table>
                    <asp:PlaceHolder ID="plhOperator" runat="server">
                        <tr>
                            ...
                            <td colspan="5">
                                Tên
                                <asp:DropDownList ID="ddlOperators" runat="server" Width="100">
                                </asp:DropDownList>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td colspan="8" align="center">
                                    <asp:HiddenField ID="hiddenId" runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"Id") %>' />
                                    <h4>
                                        <%# DataBinder.Eval(Container.DataItem,"Name") %></h4>
                                </td>
                            </tr>
