...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <fieldset>
        ...
        <asp:Button ID="btnExportDriverCollect" runat="server" Text="Export DriverCollect"
            OnClick="btnExportDriverCollect_Click" CssClass="button" Style="left: 9px; cursor: pointer" />
        <div>
            <ul style="list-style: none; padding: 5px 0 0; margin: 0px;" class="tabbutton">
        ...
        <div style="float: right;">
            <span style="position: relative; top: -7px; margin-right: 4px;">Payment status:</span>
            <ul style="list-style: none; padding: 0px; padding-top: 5px; margin: 0px; display: inline-block"
                class="tabbutton">
