<%@ Control Language="c#" AutoEventWireup="True" Codebehind="LanguageSwitcher.ascx.cs" Inherits="CMS.Modules.LanguageSwitcher.LanguageSwitcher" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
