<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Register.ascx.cs" Inherits="CMS.Modules.User.Register" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
