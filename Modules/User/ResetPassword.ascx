<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ResetPassword.ascx.cs" Inherits="CMS.Modules.User.ResetPassword" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
