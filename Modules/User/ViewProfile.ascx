<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ViewProfile.ascx.cs" Inherits="CMS.Modules.User.ViewProfile" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
