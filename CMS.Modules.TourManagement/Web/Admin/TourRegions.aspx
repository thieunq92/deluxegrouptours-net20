<%@ Page Language="C#" MasterPageFile="TourMaster.Master" AutoEventWireup="true"
    Codebehind="TourRegions.aspx.cs" Inherits="CMS.Modules.TourManagement.Web.Admin.TourRegions"
    Title="Untitled Page" %>
    ...
    <fieldset>
        ...
        <div class="settinglist">
            <div class="listbox">
                ...
                <asp:Button ID="btnAddNewRegion" runat="server" OnClick="btnAddNew_Click" CssClass="button" />
            </div>
            <div class="wbox">
