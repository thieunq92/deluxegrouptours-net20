...
namespace CMS.Modules.TourManagement.Web.Admin
{
    public partial class Admin : MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //hyperLinkProviderList.NavigateUrl = string.Format("/Modules/TourManagement/Admin/ProviderList.aspx?NodeId={0}&SectionId={1}", Request.QueryString["NodeId"], Request.QueryString["SectionId"]);
