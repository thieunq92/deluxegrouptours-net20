<%@ Page Language="C#" MasterPageFile="TourMaster.Master" AutoEventWireup="true"
    Codebehind="AgentUserList.aspx.cs" Inherits="CMS.Modules.TourManagement.Web.Admin.AgentUserList"
    Title="Untitled Page" %>
                                ...
                                <HeaderTemplate>
                                    <tr>
                                        <th style="width: 150px;">
                                            <%# base.GetText("labelUserName") %>
                                        </th>
                                        <th style="width: 150px;">
                                            <%# base.GetText("labelFullName") %>
                                        </th>
                                        <th style="width: 150px;">
                                            <%# base.GetText("labelRegisteredTime") %>
                                        </th>
                                    </tr>
                                </HeaderTemplate>
                            </asp:Repeater>
