...
namespace CMS.Modules.TourManagement.Domain
{
	...
	/// </summary>
	public class TourTransportSalePrice 
		{
		...
		public TourTransportSalePrice() { 
				_id=-1;
			}

        public TourTransportSalePrice(int roleId, int numberOfCustomers, int tourRestaurantId, decimal totalNetPrice, decimal totalSalePrice, DateTime lastCalculated)
		{
			this._roleId = roleId;
		...
		public virtual int TourTransportId
		{
