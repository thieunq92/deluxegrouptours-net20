...
namespace CMS.Modules.TourManagement.Domain
{
	...
	/// </summary>
	public class TourHotelSalePrice
		{
		...
		public TourHotelSalePrice() 
		{
			_id = -1;
		}

		public TourHotelSalePrice( int roleId, int numberOfCustomer, decimal totalNetPrice, decimal totalSalePrice )
		{
			this._roleId = roleId;
	    ...
	    public virtual int TourHotelId
	    {
